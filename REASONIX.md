...
- **`.reasonix-xiaomi/semantic/`** is auto-generated vector index. Never hand-edit.
- **`sessions/` and `.reasonix-xiaomi/sessions/`** are user-private, git-ignored (per `.gitignore`).
