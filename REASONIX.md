...
- **`.xiaomi-reasonix/semantic/`** is auto-generated vector index. Never hand-edit.
- **`sessions/` and `.xiaomi-reasonix/sessions/`** are user-private, git-ignored (per `.gitignore`).
