...
import { DEFAULT_CONTEXT_TOKENS, XIAOMI_CONTEXT_TOKENS, pricingFor } from "@/telemetry/stats.js";
...
const status: SlashHandler = (_args, loop, ctx) => {
  const ctxMax = XIAOMI_CONTEXT_TOKENS[loop.model] ?? DEFAULT_CONTEXT_TOKENS;
