...
export class SkillStore {
  ...
  roots(): SkillRoot[] {
    ...
    if (this.projectRoot) {
      out.push({
        dir: join(this.projectRoot, ".reasonix-xiaomi", SKILLS_DIRNAME),
        scope: "project",
      });
    ...
    out.push({ dir: join(this.homeDir, ".reasonix-xiaomi", SKILLS_DIRNAME), scope: "global" });
  ...
  createWithContent(
    ...
    const root =
      scope === "project"
        ? join(this.projectRoot ?? "", ".reasonix-xiaomi", SKILLS_DIRNAME)
        : join(this.homeDir, ".reasonix-xiaomi", SKILLS_DIRNAME);
