...
export class SkillStore {
  ...
  roots(): SkillRoot[] {
    ...
    if (this.projectRoot) {
      out.push({
        dir: join(this.projectRoot, ".xiaomi-reasonix", SKILLS_DIRNAME),
        scope: "project",
      });
    ...
    out.push({ dir: join(this.homeDir, ".xiaomi-reasonix", SKILLS_DIRNAME), scope: "global" });
  ...
  createWithContent(
    ...
    const root =
      scope === "project"
        ? join(this.projectRoot ?? "", ".xiaomi-reasonix", SKILLS_DIRNAME)
        : join(this.homeDir, ".xiaomi-reasonix", SKILLS_DIRNAME);
