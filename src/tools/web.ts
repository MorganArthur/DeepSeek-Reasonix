...
export interface WebFetchOptions {
  ...
  timeoutMs?: number;
  /** Config path for provider-specific keys. Defaults to ~/.reasonix-xiaomi/config.json. */
  configPath?: string;
  signal?: AbortSignal;
}
...
export interface WebToolsOptions {
  ...
  /** Config path to read at tool-call time. Defaults to ~/.reasonix-xiaomi/config.json. */
  configPath?: string;
}
