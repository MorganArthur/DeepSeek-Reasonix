export const en = {
  ...
  settings: {
    ...
    saveKey: "Save key",
    baseUrl: "base url",
    baseUrlPlaceholder: "https://api.xiaomimimo.com/v1 (default)",
    ...
    effort: "effort",
    effortMax: "max (legacy no-op — Xiaomi MiMo accepts low / medium / high)",
  ...
  mcp: {
    ...
    marketplaceRestartHint:
      "Spec written to ~/.reasonix-xiaomi/config.json. Restart `reasonix code` to bridge the server (live hot-reload is on the roadmap).",
  },
  memory: {
    ...
    pickDesc: "Project REASONIX.md is committable; global notes live in ~/.reasonix-xiaomi/memory/.",
    chars: "{count} chars",
    saved: "saved {scope}",
  ...
  semantic: {
    ...
    apiUrl: "API URL",
    apiKey: "API key",
    apiKeyStoredNote: "API key is stored in ~/.reasonix-xiaomi/config.json — do not share that file.",
