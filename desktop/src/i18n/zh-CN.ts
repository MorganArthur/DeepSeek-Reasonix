...
export const zhCN: typeof en = {
  ...
  toast: {
    ...
    newSession: "已开新会话",
    cleared: "已清空 UI",
    aboutLine: "Reasonix v{version} · cache-first 小米 MiMo agent",
  },
  composer: {
    busy: "reasonix 正在思考…",
    idle: "问点什么",
  ...
  settings: {
    ...
    editorDefault: "(默认)",
    apiKey: "API key",
    apiKeyHint: "小米 MiMo key — 保存到 ~/.reasonix-xiaomi/config.json (0600)。",
    apiKeyNotSet: "(未设置)",
    apiKeyCancel: "取消",
    apiKeySave: "保存",
    apiKeyShow: "显示",
    ...
    skillsEmpty:
      "没有可用技能。可在 ~/.reasonix-xiaomi/skills/ 或 项目根/.reasonix-xiaomi/skills/ 下创建 SKILL.md。",
  ...
  effort: {
    ...
    maxDesc: "旧配置兼容；小米 MiMo 仅接受 low / medium / high",
  },
  checkpoint: {
    title: "步骤已完成",
    progress: "{done} / {total}",
  ...
  app: {
    ...
    setup: {
      welcome: "欢迎使用 Reasonix",
      description: "首次使用需要配置小米 MiMo API Key 与工作目录。Key 仅保存在本地。",
      workspace: "工作目录",
      notSelected: "未选择",
      choose: "选择…",
      saveAndStart: "保存并开始",
