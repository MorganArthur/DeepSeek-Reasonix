...
export const de: typeof en = {
  ...
  settings: {
    ...
    apiKeyHint: "Xiaomi-MiMo-Schlüssel — gespeichert in ~/.reasonix-xiaomi/config.json (0600).",
    ...
    skillsEmpty:
      "Keine Skills verfügbar. Erstelle SKILL.md unter ~/.reasonix-xiaomi/skills/ oder .reasonix-xiaomi/skills/ in deinem Projekt-Root.",
