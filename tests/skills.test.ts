...
function writeSkillDir(
  ...
  const parent =
    which === "global"
      ? join(homeOrProject, ".reasonix-xiaomi", "skills")
      : which === "project"
        ? join(root, ".reasonix-xiaomi", "skills")
        : homeOrProject;
...
function writeFlatSkill(
  ...
  const skills = join(dir, ".reasonix-xiaomi", "skills");
...
describe("SkillStore", () => {
  ...
  it("surfaces project-scope skills from <projectRoot>/.reasonix-xiaomi/skills", () => {
    writeSkillDir(
      projectRoot,
      "project",
      "deploy",
  ...
  it("skips dotfiles that would masquerade as skills", () => {
    ...
    const dotDir = join(home, ".reasonix-xiaomi", "skills");
