...
function writeSkillDir(
  ...
  const parent =
    which === "global"
      ? join(homeOrProject, ".xiaomi-reasonix", "skills")
      : which === "project"
        ? join(root, ".xiaomi-reasonix", "skills")
        : homeOrProject;
...
function writeFlatSkill(
  ...
  const skills = join(dir, ".xiaomi-reasonix", "skills");
...
describe("SkillStore", () => {
  ...
  it("surfaces project-scope skills from <projectRoot>/.xiaomi-reasonix/skills", () => {
    writeSkillDir(
      projectRoot,
      "project",
      "deploy",
  ...
  it("skips dotfiles that would masquerade as skills", () => {
    ...
    const dotDir = join(home, ".xiaomi-reasonix", "skills");
