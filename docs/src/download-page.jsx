    ...
    <section className="dl-hero">
      ...
      <div className="dl-hero-grid">
        <div>
          ...
          <p className="lede">
            {t({
              zh: <>原生 <b>Tauri</b> 客户端 · 自带 Node runtime · 共享 <b>~/.reasonix-xiaomi</b> 配置与会话。多 tab 并行，右侧栏列出当前会话读过和改过的文件，底部 cost / cache / token 实时表盘。</>,
              en: <>Native <b>Tauri</b> client · bundled Node runtime · shares <b>~/.reasonix-xiaomi</b> config + history with the CLI. Multi-tab sessions, side panel listing files read / edited this session, live cost / cache / token meters along the bottom.</>,
            }, lang)}
          </p>
