...
(function () {
  ...
  const translations = {
    en: {
      ...
      "conf.sub":
        "One JSON file at <code>~/.reasonix-xiaomi/config.json</code>, plus per-project overrides under <code>.reasonix-xiaomi/</code>. Point. Click. Wire in your stack.",
      "conf.read": "Read →",
      ...
      "cli.f.noconf": "ignore ~/.reasonix-xiaomi/config.json (CI)",
    ...
    zh: {
      ...
      "conf.title": "五分钟配置完",
      "conf.sub":
        "一个全局 JSON <code>~/.reasonix-xiaomi/config.json</code>，加上项目级 <code>.reasonix-xiaomi/</code> 下的覆盖。点几下，把你的工具链接进来。",
      "conf.read": "阅读 →",
      ...
      "cli.f.noconf": "忽略 ~/.reasonix-xiaomi/config.json（CI 友好）",
